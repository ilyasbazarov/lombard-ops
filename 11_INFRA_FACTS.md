...
| Пользователь `LOMBARD_RO` | существует, пароль известен владельцу (подтверждено подключением); свои гранты — `SELECT` на 9 таблиц из `briefs/T-0-5.md`. **НЕ read-only фактически**: `PUBLIC` даёт `D/I/R/S/U` на эти же 9 таблиц и ещё ≥98 других — измерено `T-0-5`, 2026-08-11, см. `reference/T-0-5_readonly_measurement_2026-08-11.md` | вне репо (пароль) |
