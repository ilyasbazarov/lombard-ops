...
| Сервер | Windows Server, промежуточный узел убран админом; сервер напрямую в LAN: 192.168.88.209 (был 192.168.99.100 за пробросом), работает 24/7, ИБП нет (техдолг ADR-008) | админ-креды — у Ilyas (от Исы) |
